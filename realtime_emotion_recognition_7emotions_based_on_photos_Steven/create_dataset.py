...
while(True):
    ...
    # show video stream
    cv2.putText(gray, "A - Anger", (10, 15),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "D - Disgust", (10, 35),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "F - Fear", (10, 55),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "H - Happy", (10, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
    cv2.putText(gray, "N - Neutral", (10, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
    cv2.putText(gray, "S - Sad", (10, 55), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
    cv2.putText(gray, "U - Surprise", (10, 55), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
    ...
    if  key == ord('q'):
        ...
        capture_face_expression(face_expression,"anger",dataset_path)
        print("[INFO] Anger")
    elif key == ord('d'):
