# load in a mp4 file, it will be converted to mp3, then mp3 will be converted to text
#then the text will be analysed by NLP to detect the emotions

from moviepy.editor import *

#mp4_file = 'WIN_20201113_13_45_57_Pro.mp4'
mp4_file = 'WIN_20201113_14_33_40_Pro.mp4'
