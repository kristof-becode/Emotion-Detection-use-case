...
labels = ["fake_smile", "neutral","smile"]
...
while(True):
    ...
    cv2.putText(gray, "S - Smile", (10, 35),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "F - Fake_Smile", (10, 55),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    ...
    if  key == ord('q'):
        ...
        capture_face_expression(face_expression,"smile",dataset_path)
        print("[INFO] Smile")
    elif key == ord('f'):
        capture_face_expression(face_expression,"fake_smile",dataset_path)
        print("[INFO] Fake Smile")
